...
export const metadata = {
  ...
  description:
    "Barrios, consejos y enlaces fiables para reservar hoteles en Tetuán.",
};
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10 space-y-6">
      ...
      <p className="text-slate-700">
        Zonas: Medina, Ensanche, Centro. Si quieres tranquilidad: Ensanche; para
        turismo: Medina.
      </p>
      ...
      <div className="card p-5 space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <AffiliateLink partner="agoda" to={agoda} className="btn btn-ghost">
            Agoda
          </AffiliateLink>
        </div>
        <p className="text-xs text-slate-500">
          * Enlaces de afiliado; a ti no te cuesta más.
        </p>
      </div>
    </main>
  );
